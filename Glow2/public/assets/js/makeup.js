document.addEventListener("DOMContentLoaded", function() {
    document.querySelector('.chevron-down-makeup').addEventListener('click', function() {
        const filterContainer = document.querySelector('.filter-container-makeup');

        // Check if the filter container is currently visible
        const isVisible = filterContainer.classList.contains('filter-container-show-makeup');
        ...
        filterContainer.classList.toggle('filter-container-show-makeup'); // Toggle the filter container visibility
