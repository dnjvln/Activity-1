<template>
    ...
    <section class="rectangle-white">
        <div class="navbar">
            <div v-for="(link, index) in links" :key="index" :class="`button button${index + 1}`">
                <div class="button-content">
                    <Link :href="link.href" class="button-text">{{ link.text }}</Link>
                </div>
            </div>
            <div
                style="width:1440px;height:1px; background-position:fixed; background-image:url('/assets/img/75ef183b-96da-4dc4-848a-fdf62ed6c3ed.png');background-size:cover;background-repeat:no-repeat;position:absolute;top:110px;left:500px;z-index:600">
            </div>
    ...
    <div class="header">
        ...
        <div class="search-container">
            <input class="search-input" placeholder="Find out your dream beauty product..." />
        </div>
        ...
        <div style="width:1440px;height:1px;background-position:center;background-image:url('assets/img/61558280-4a75-477e-8551-805447bd4a9a.png');background-size:cover;background-repeat:no-repeat;position:absolute;top:118px;left:0;z-index:216">
        </div>
    </div>
            ...
            <div class="rectangle-heart">
                ...
                <div v-for="(item, index) in favorites" :key="index" class="group-1-cart">
                    <div class="group-2-cart">
                        ...
                        <div class="delete" @click="removeFavorite(index)">Remove</div>
                    </div>
...
<script>
import { Favorites, ToggleCart, ToggleProfile } from '/resources/js/Pages/index.js';
    ...
    data() {
        return {
            ...
            favorites: [
                ...
                {
                    name: "Luxe Organix Miracle Solutions Acne Derm + Toner 150ml",
                    price: "₱349",
                    quantity: 1,
                    image: '/assets/img/tonerLuxOrganix.png'
                },
                {
                    name: "Lameila 4D Curling Eyelash Mascara Extension Black...",
                    price: "₱25",
                    quantity: 1,
            ...
            cartItems: [
                ...
                {
                    name: "Garnier Micellar Water with Argan Oil (125ml/400mL)",
                    price: "₱360",
                    quantity: 1,
                    image: '/assets/img/garnier-micellar.png'
                },
                {
                    name: "Black Mascara Three-Dimensional Curling Thick Anti-Smudge",
                    price: "₱69",
                    quantity: 1,
                    image: '/assets/img/makeup.png'
                }
