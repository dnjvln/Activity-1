        ...
        <div class="main-container-uploadeed">
            <div class="frame-uploadeed">
                <section class="add-product-container">
                    <span class="upload-product-uploaad">Create a Product!</span>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            makeupUrl: '/makeup',
            skincareUrl: '/skincare', productName: '',
            description: '',
            price: '',
            selectedType: null,
...
.flex-column-ada-uploadeed a {
    text-decoration: none;
    color: inherit;
    transition: color 0.3s ease;
}

.flex-column-ada-uploadeed a:hover {
    color: #bf68ce;
}

.flex-column-ada-uploadeed .create-product-uploadeed {
    color: #bf68ce;
}
