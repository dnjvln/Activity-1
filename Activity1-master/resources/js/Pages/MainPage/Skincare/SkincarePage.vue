<template>
    <div class="main-container">
        ...
        <section class="product-section-products">
            <div class="product-container-products" v-for="product in products" :key="product.id" @click="viewProductDetails(product.id)">
...
export default defineComponent({
    ...
    setup() {
        ...
        const fetchProducts = async () => {
            try {
                const response = await axios.get('/api/products', { params: { type_id: 1 } });
    ...
    methods: {
        ...
        viewProductDetails(productId) {
            router.visit(route('products.details', productId));
        },
    },
});
</script>
