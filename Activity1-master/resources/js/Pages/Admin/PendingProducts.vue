                ...
                <div class="overlap">
                    ...
                    <div class="overlap-2">
                        <div class="widget">
                            ...
                            <div class="text-wrapper-9">Pending Products List</div>
                        </div>
...
export default {
    ...
    methods: {
        async fetchPendingSellerProducts() {
            try {
                const response = await axios.get('/admin/products/pending-sellers');
                console.log('Pending Seller Products:', response.data);
                this.products = response.data; // Populate the products array
            } catch (error) {
                console.error('Failed to fetch pending seller products:', error);
                this.errorMessage = 'Failed to fetch pending seller products. Please try again.';
            }
        },
    ...
    mounted() {
        this.fetchPendingSellerProducts();
    },
};
</script>
